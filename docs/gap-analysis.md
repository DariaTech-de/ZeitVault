...
Status-Zählung (79 Anforderungen; Stand nach Schnitt 3, 2026-07-08): implementiert 22 (B-02 aus Schnitt 0; A-03/K-01/K-03/K-06 aus Schnitt 1; B-08/B-09 aus Schnitt 2; B-01/B-03/B-04/B-05/B-06/B-07/B-11/B-12/B-13 aus Schnitt 3) · teilweise 28 (B-10 bleibt teilweise bis F-04) · fehlt 26 · widerspricht 0 · nicht auffindbar 3 (I-04, J-05, K-05). Nachtrag zur Schnitt-1-Abnahme (2026-07-08): Implicit-Close durch das unresolved-Zustandsmodell ersetzt (ADR-0019), Rundung ans Ereignis verlegt + Summeninvariante (B-12-Basis), Korrektur-Abschluss der Ladefenster, Einsatzort-Übersteuerung beim Stempeln validiert, Europe/Berlin-Fallback entfernt, `instantFromLocal` mit DST-Eingabevalidierung. Nebenbefunde: [`findings.md`](findings.md).
